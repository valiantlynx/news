...
function HeaderWithTabs() {
  ...
  const child2 = <ArticleCardVertical
    image={newsPages[1].urlToImage}
    title={newsPages[1].title}
    country={newsPages[1].publishedAt}
    source={newsPages[1].source.name}
    description={newsPages[1].content}
  />;
    ...
    <div>
      ...
      <Container my="sm">
        <SimpleGrid cols={1} spacing="md" >
          <Grid breakpoints={[{ maxWidth: 'md', cols: 1 }]}>
            {content}
          </Grid>
        </SimpleGrid>
      </Container>
